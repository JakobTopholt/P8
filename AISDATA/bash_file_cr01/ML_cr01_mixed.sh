...
#SBATCH --job-name="AIS CR01 - mixed (train+QB)"
#SBATCH --mem=150G
...
WORKLOAD="mixed"
TRAIN_MIX="range=0.25,knn=0.25,similarity=0.25,clustering=0.25"
EVAL_MIX="range=0.25,knn=0.25,similarity=0.25,clustering=0.25"
