...
Usage:
    python Utils/check_gaps.py --top 1000
    python Utils/check_gaps.py --top 1000 --suspicious-only
"""
...
def main():
    ...
    if suspicious:
        ...
        for r in suspicious:
            ...
            print(f"    Point AFTER:  lat={r['_next_lat']:.5f}  lon={r['_next_lon']:.5f}  SOG={r['_next_sog']:.1f}" if r['_next_lat'] else "    Point AFTER:  N/A")
